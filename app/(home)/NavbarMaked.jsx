  ...
  return (
    <nav className='bg-orange-500'>
...

      {
        ...
        <Link href="/"><Image src={mitnog} width="100" height="7" alt='profile'></Image></Link>
        ...
        <FavoriteBorderIcon className='mr-4 w-10 text-white'></FavoriteBorderIcon> <AddShoppingCartIcon className='mr-4 w-10 text-white'>
                +{cart?.length || 0}
          </AddShoppingCartIcon>
        <NotificationAddOutlined className='mr-7 w-10 text-white'></NotificationAddOutlined>
        <div >
        <Avatar onClick={handleMenue} alt="Remy Sharp" src="/static/images/avatar/2.jpg" />
        {
          showSettings && (
      ...
      <>
      <div className='flex items-center justify-between px-4 '>
      <Link href="/"><Image src={mitnog} width="90" height="7" alt='profile'></Image></Link>
        <div className="hidden md:flex items-center">
        <input
