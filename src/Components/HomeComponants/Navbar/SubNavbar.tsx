...
const SubNavbar: React.FC = () => {
  return (
    <div className="hidden md:max-w-[1150px] mx-auto bg-blue-700 rounded-lg md:flex items-center">
      <div className="flex font-bold  text-white text-center items-center gap-2 p-4 ">
